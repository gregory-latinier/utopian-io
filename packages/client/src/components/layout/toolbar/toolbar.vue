...
div
  ...
  q-layout-drawer(
    ...
    q-list(
      ...
      q-item(v-if="!guest && !steemEnabled", :to="`/${$route.params.locale}/profile/steem`")
      ...
      q-item(v-if="steemEnabled", :to="`/${$route.params.locale}/articles/create`")
        ...
        q-item-main(:label="$t('components.layout.toolbar.writeArticle')")
      q-item(v-if="false && steemEnabled", :to="`/${$route.params.locale}/bounties/create`")
      ...
      q-item(
      :to="{ path: `/${$route.params.locale}/search/articles` }"
    )
        q-item-side(icon="mdi-database-search")
        q-item-main(label="Articles explorer")
      q-item-separator(v-if="!guest")
